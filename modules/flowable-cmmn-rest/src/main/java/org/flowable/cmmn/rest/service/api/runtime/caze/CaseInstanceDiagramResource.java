...
public class CaseInstanceDiagramResource extends BaseCaseInstanceResource {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 400, message = "Indicates the requested case instance was not found but the case does not contain any graphical information (CMMN DI) and no diagram can be created."),
